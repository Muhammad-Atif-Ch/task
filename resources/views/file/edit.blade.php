                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('admin.product.update', $product->id) }}" method="post" enctype="multipart/form-data" id="form">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-4">
                                            <label for="price">Wholeseller Price<span style="color: red; font-size: 15px">*</span></label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">$</span>
                                                <input type="number" class="form-control" id="wholeseller_price" name="wholeseller_price" value="{{ $product->wholeseller_price }}">
                                                <span class="input-group-text">.00</span>
                                            </div>
                                            @error('wholeseller_price')
                                            <div class="text-danger p-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="discount_price">Wholeseller Discount Price</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">$</span>
                                                <input type="number" class="form-control" id="wholeseller_discount_price" name="wholeseller_discount_price" value="{{ $product->wholeseller_discount_price }}">
                                                <span class="input-group-text">.00</span>
                                            </div>
                                            @error('wholeseller_discount_price')
                                            <div class="text-danger p-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <input type="hidden" name="oldImg[]" class="form-control" id="oldImg" multiple value="{{ $product->images->toArray() }}">
                                            <input type="hidden" name="id" class="form-control" id="banner_id" multiple value="{{ $product->images->toArray() }}">
                                            <input type="hidden" name="newImg" class="form-control" id="newImg" multiple value="">
