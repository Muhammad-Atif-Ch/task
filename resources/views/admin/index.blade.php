                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <p class="mb-0"><span class="col-green">{{$order}}%</span> Increase</p><?php
                                            else:
                                            $order = 100;?>
                                            <p class="mb-0"><span class="col-green">{{$order}}%</span> Increase</p><?php
                                            endif;
                                            ...
                                            $order = $percent_from_order / $previousMonthlyOrder * 100;?>
                                            <p class="mb-0"><span class="col-orange">{{$order}}%</span> Decrease</p><?php
                                            endif;
                                            } else {
                                            $order = 0;?>
                                            <p class="mb-0"><span class="col-green">{{$order}}%</span> Increase</p><?php
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <p class="mb-0"><span class="col-green">{{$user}}%</span> Increase</p><?php
                                            else:
                                            $user = 100;?>
                                            <p class="mb-0"><span class="col-green">{{$user}}%</span> Increase</p><?php
                                            endif;
