                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($coupons as $coupon)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.coupon.edit', $coupon->id) }}" class="btn btn-primary"><i data-feather="edit"></i></a>
                                                    @if ($coupon->status == 'deactive')
                                                        <a href="{{ route('admin.coupon.activate', $coupon->id) }}" class="btn btn-danger">
                                                            <i data-feather="toggle-left"></i></a>
                                                    @else
                                                        <a href="{{ route('admin.coupon.deactivate', $coupon->id) }}" class="btn btn-primary">
