    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
                <div class="dropdown-title">Hello Person</div>
                <a href="" class="dropdown-item has-icon"> <i class="far fa-user"></i> Profile</a>
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item has-icon text-danger" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
